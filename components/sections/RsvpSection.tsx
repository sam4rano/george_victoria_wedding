...
export function RsvpSection() {
  return (
    <motion.section
      ...
      className="relative overflow-hidden bg-[#101922] py-16 md:py-24"
    >
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <motion.p
          ...
          className="mt-4 font-body text-neutral-300"
        >
          ...
          {CONTACTS.map(({ name, tel }, i) => (
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border border-white/20 bg-white/5 px-5 py-3 font-body text-sm font-medium text-white shadow-lg transition-colors hover:border-rose/40 hover:bg-white/10"
              >
                <Phone className="size-5 shrink-0 text-rose/80" />
                <span>{name}</span>
